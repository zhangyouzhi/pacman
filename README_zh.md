...
Pacman 是为 [Hexo](http://hexo.io) 设计的一款清新且具有响应式的主题，拥有更丰富的特性并支持了很多的国内服务。Jacman 始于 [Pacman](https://github.com/A-limon/jacman) 修改而来。

[主题演示](http://zhangyouzhi.com/pacman) | [ZhangYouzhi's Blog](http://zhangyouzhi.com)
...
- **图片相关 Image**  
 设置网站图标、网站logo、作者头像等。
- **首页模式 index**  
 主题提供了两种首页展示模式，你可以访问 [主题演示](http://zhangyouzhi/pacman) 和 [ZhangYouzhi's Blog](http://zhangyouzhi.com) 来了解其不同。
- **作者 author**  
